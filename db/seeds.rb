...
# TORSO Items
jacket = Item.create(name: "Leather Biker Jacket", img_url: "https://i.imgur.com/iAxJlKkt.jpg", body_part: "torso", min_temp: 32, max_temp: 60)
parka = Item.create(name: "Canada Goose Parka", img_url: "https://i.imgur.com/ocGqDGxt.jpg", body_part: "torso", min_temp: 0, max_temp: 32)
shirt = Item.create(name: "B/W Striped Tee", img_url: "https://i.imgur.com/cVWw3K9t.jpg", body_part: "torso", min_temp: 60, max_temp: 90)
jacket2 = Item.create(name: "Olive Worker Jacket", img_url: "https://i.imgur.com/HU3nub2t.jpg", body_part: "torso", min_temp: 32, max_temp: 60)
polo = Item.create(name: "Red Patterned Polo", img_url: "https://i.imgur.com/ZvHiUK5t.jpg", body_part: "torso", min_temp: 60, max_temp: 90)
shirt2 = Item.create(name: "Red Tee", img_url: "https://i.imgur.com/q30mwwbt.jpg", body_part: "torso", min_temp: 0, max_temp: 90)
suitJacket1 = Item.create(name: "Burgundy Suit Jacket", img_url: "https://i.imgur.com/b0KbRdYt.jpg", body_part: "torso", min_temp: 32, max_temp: 70)
shirt3 = Item.create(name: "White Tee", img_url: "https://i.imgur.com/9Zu5iWKt.jpg", body_part: "torso", min_temp: 0, max_temp: 90)
shirtP = Item.create(name: "Patterned ls Button-up Shirt", img_url: "https://i.imgur.com/8ZOiCANt.jpg?1", body_part: "torso", min_temp: 0, max_temp: 90)
...
shirt4 = Item.create(name: "Black Tee", img_url: "https://i.imgur.com/vkYuuw9t.jpg", body_part: "torso", min_temp: 0, max_temp: 90)
...
jeans2 = Item.create(name: "Black Skinny Fit Jeans", img_url: "https://i.imgur.com/ATDFu5Gt.jpg", body_part: "legs", min_temp: 10, max_temp: 75)
jeans3 = Item.create(name: "Light Blue Distressed Biker Jeans", img_url: "https://i.imgur.com/3FnOz95t.jpg", body_part: "legs", min_temp: 10, max_temp: 80)
jeans4 = Item.create(name: "Khaki Slim Chinos", img_url: "https://i.imgur.com/6hGzFVVt.jpg?1", body_part: "legs", min_temp: 10, max_temp: 80)
jeans5 = Item.create(name: "Black Slim Fit Jeans", img_url: "https://i.imgur.com/s4CJs6ct.jpg", body_part: "legs", min_temp: 10, max_temp: 80)
jeans6 = Item.create(name: "Dark Denim Slim Fit Jeans", img_url: "https://i.imgur.com/BA3XgpOt.jpg", body_part: "legs", min_temp: 10, max_temp: 90)
jeans7 = Item.create(name: "Dark Denim Straight Fit Jeans", img_url: "https://i.imgur.com/L5Np0Wst.jpg", body_part: "legs", min_temp: 10, max_temp: 70)
suitPants1 = Item.create(name: "Black Suit Pants", img_url: "https://i.imgur.com/Y4uI8dft.jpg", body_part: "legs", min_temp: 10, max_temp: 70)
suitPants2 = Item.create(name: "Burgundy Suit Pants", img_url: "https://i.imgur.com/mRcvObTt.jpg", body_part: "legs", min_temp: 10, max_temp: 70)
jeans8 = Item.create(name: "Light Blue Slim Fit Jeans", img_url: "https://i.imgur.com/13qRaXRt.jpg", body_part: "legs", min_temp: 10, max_temp: 80)
...
shoe3 = Item.create(name: "Zara Flip Flops", img_url: "https://i.imgur.com/kgP4VXWt.jpg", body_part: "feet", min_temp: 70, max_temp: 100)
shoe4 = Item.create(name: "Rain Boots", img_url: "https://i.imgur.com/aTCBGemt.jpg", body_part: "feet", min_temp: 33, max_temp: 70)
shoe5 = Item.create(name: "Black Brogues", img_url: "https://i.imgur.com/HKR1Q0Vt.jpg", body_part: "feet", min_temp: 0, max_temp: 75)
shoe6 = Item.create(name: "Brown Brogues", img_url: "https://i.imgur.com/UizOArFt.jpg", body_part: "feet", min_temp: 0, max_temp: 75)
shoe7 = Item.create(name: "White Converse AllStar Low", img_url: "https://i.imgur.com/OdqTciLt.jpg", body_part: "feet", min_temp: 50, max_temp: 100)
shoe8 = Item.create(name: "Maroon Converse AllStar Hi", img_url: "https://i.imgur.com/jgtwVrPt.jpg", body_part: "feet", min_temp: 50, max_temp: 100)
...
ItemCategory.create(item_id: shirtP.id, category_id: clear.id )
...
ItemCategory.create(item_id: shoe1.id, category_id: clear.id )
ItemCategory.create(item_id: shoe1.id, category_id: clouds.id )
ItemCategory.create(item_id: shoe2.id, category_id: clear.id )
ItemCategory.create(item_id: shoe3.id, category_id: all.id )
ItemCategory.create(item_id: shoe4.id, category_id: thunderstorm.id )
ItemCategory.create(item_id: shoe5.id, category_id: all.id )
ItemCategory.create(item_id: shoe6.id, category_id: all.id )
ItemCategory.create(item_id: shoe7.id, category_id: all.id )
ItemCategory.create(item_id: shoe8.id, category_id: all.id )
